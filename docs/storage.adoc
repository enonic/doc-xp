...
* <<deployment/data#snapshot-restore, snapshot and restore>> to rollback the entire system to a point in time
* <<deployment/data#export-import, exporting and importing>> nodes and tree structures using a human readable format
* <<deployment/data#dump-load, dumping and loading>> your entire storage.
* <<deployment/data#backup, backing up>> your data safely.