...
TIP: Get started running. Use one of our link:https://market.enonic.com/starters[starters] to bootstrap your development project.
...
Enonic supports JS/TS based build tools like link:https://market.enonic.com/vendors/enonic/tsup-starter[TSUP] and https://market.enonic.com/vendors/enonic/webpack-starter[Webpack], but relies on https://gradle.org/[Gradle] as the main builder.
...
TIP: Check out link:https://market.enonic.com/vendors/enonic/library-starter[the library starter] if you are planning to build your own library.
...
The core functionality of XP is exposed via standard libraries. Check out the <<../api#,Standard Libraries documentation>>. You will also find additional libraries on link:https://market.enonic.com/libraries[Enonic Market]
