...
When changing files ending with `.cfg`, application using them will automatically restart with the new configuration. Files ending with `.properties` require a full restart of the XP instance to be effectively applied.
