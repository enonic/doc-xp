...
In this case, a link:./config#vhost[vhost configuration] looking like this will get the job done:
...
Visit the link:./config#vhost[vhost configuration] section for more details.
