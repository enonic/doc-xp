...
+
<7> `work/` Cache and generated bundles (apps etc) are stored here.
+
NOTE: For optinal performance ,mount this to a local persisted volume. Caches do not need to be re-generated after each restart.
+
