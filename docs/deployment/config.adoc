...
virtual.schema.override:: If there is a schema in the virtual application with the same name as in the real one, priority will be given to the scheme from the virtual application. Default: `true`.
