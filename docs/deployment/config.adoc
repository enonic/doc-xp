...
It also requires granting certain permissions. You can find mre information in https://github.com/hazelcast/hazelcast-kubernetes/tree/1.5.x[Hazelcast Discovery Plugin for Kubernetes] documentation.
