...
# xp.suPassword = {sha512}b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c706a8bb980b1d7785e5976ec049b46df5f1326af5a2ea6d103fd07c95385ffab0cacbc86
...
xp.stop.gracePeriod:: Time in milliseconds XP waits for all services to stop. Default is `600000` (10 minutes). Before XP 7.14.3 value was 10000 (10 seconds) and not configurable.
...
TIP: To generate `sha512` hash suitable for `xp.suPassword`, you can use the following command:
[source,terminal]
----
printf '{sha512}%s\n' "$(echo -n 'pw' | sha512sum | cut -d' ' -f1)"
----
...
cache.size:: Added in image:xp-7130.svg[XP 7.13.0,opts=inline] and removed in image:xp-7150.svg[XP 7.15.0,opts=inline]. Specifies the maximum number of nodes to keep in memory. Default: `100000`
