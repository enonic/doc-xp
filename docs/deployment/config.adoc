...
The XP_HOME/license folder is where the system looks for the licenses that some apps require to function.  The Enonic apps, Content Studio+, Live Trace and Booster, all require an XP license to run.  It may be uploaded directly in the apps or placed in this folder with the name `enonic.platform.subscription.lic`.
