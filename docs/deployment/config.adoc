...
You can also pass `allVersions` parameter to include pre-releases of market apps

.allVersions configuration
[source,properties]
----
marketUrl = https://market.enonic.com/applications?allVersions=true
----
Production servers should never have this enabled.
