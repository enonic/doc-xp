...
image:xp-7131.svg[XP 7.13.1,opts=inline]
...
As such, it may lead to slower system response and reduced efficiency. By default, this setting is turned off (false) to prioritize optimal performance.
