...
memoryLimit:: image:xp-780.svg[XP 7.8.0,opts=inline] Defines (soft) Java Heap memory limit for image processing. Either in percentage of total Java Heap, or in memory units (mb, gb, ...). Default: `10%`
