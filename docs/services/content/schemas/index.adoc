...
[.thumb]
image::Content-selector-tree.png[Input box with a dropdown with a tree structure, 700]

Showstatus set to true:
[.thumb]
image::Content-selector-status.png[Input box with a dropwdown showing status on each option, 700]

Hide icon set to true:
[.thumb]
image::Content-selector-no-icon.png[Input box without an icon, 700]
