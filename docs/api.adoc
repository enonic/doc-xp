...
Java developers, or anyone interested in the platform core may browse http://repo.enonic.com/public/com/enonic/xp/docs/{version}/docs-{version}-javadoc.zip!/index.html[the XP JavaDoc]
or http://repo.enonic.com/public/com/enonic/xp/docs/{version}/docs-{version}-javadoc.zip[download it as a zip file].
