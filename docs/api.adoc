...
XP ships with a large number of build in JavaScript libraries that can be accessed when <<dev#, developing Enonic apps>>. These are listed below this page in the documentation menu.
