...
Image service:: Requests for the `_/media:image/` URL pattern activate the <<site-engine/image-service#,image service>>, which will process and return images on demand.
