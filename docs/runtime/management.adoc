...
Commands to manage applications to the running enonic XP instance.
...
image:xp-760.svg[XP 7.6.0,opts=inline] Uninstalls an application by the specific application key.
...
image:xp-760.svg[XP 7.6.0,opts=inline] Starts an application by the specific application key.
...
image:xp-760.svg[XP 7.6.0,opts=inline] Stops an application by the specific application key.
