...
- `list` - returns the details of applications which already installed
- `installed` - returns the details of just installed an application
- `state` - returns the details of just started or stopped an application
- `uninstalled` - returns the `key` of just removed an application

Once a client was subscribed will be sent the first event `list`.
