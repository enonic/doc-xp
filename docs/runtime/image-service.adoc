...
. Scale and optional style filters, with prettyfied URL-safe name, followed by a forward slash. +
  Example: `block-300-100-0.5-0/`
...
----
/_/image/c82262a6-77d6-4276-b0e7-fe82f4eb57b8:1feb57ed672f8c3b9fd6d4614878dafd9882298b/block-300-100-0.5-0/content-name.jpeg
----
...
Applies a Gaussian blur effect, based on the given pixel radius. The opposite of <<sharpen>>, although it's not possible to reverse a sharpen with a blur.
