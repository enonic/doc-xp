...
NOTE: Stemming is language-dependant so content needs a <<indexing#languages,language>> to be set for stemming to work, or it must set directly to node indices!
