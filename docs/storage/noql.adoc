...
It exposes field values used for sorting.
...
unit:: The string representation of distance unit to use. Defaults to "m" or "meters", the list of available values below:
. `"m" or "meters"`
. `"in" or "inch"`
. `"yd" or "yards"`
. `"ft" or "feet"`
