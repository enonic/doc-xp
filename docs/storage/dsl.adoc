...
.Matches if the field has one of exact values in typed index.
[source,json]
----
{
  "in": {
...
|query
|string
|The search-string to match a field's value.
Support the set of <<search-string operators:,operators>>.
