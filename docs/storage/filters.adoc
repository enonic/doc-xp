...
WARNING: Filters are deprecated and will be removed in future XP versions. It is recommended to use <<dsl#_filter, query filtering>> instead of filters, however they can be used simultaneously.
