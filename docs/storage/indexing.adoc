...
----
<1> This creates English-stemmed indices for allText property

=== Querying stemmed indices

Use the <<noql#stemmed,NoQL>> function or <<../storage/dsl#stemmed, DSL>> query to search against stemmed indices.
