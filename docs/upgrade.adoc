...
[source,properties]
----
include::upgrade/code/vhost_before.cfg[]
----

.After
[source,properties]
----
include::upgrade/code/vhost_after.cfg[]
----
...
[source,properties]
----
include::upgrade/code/com.enonic.xp.elasticsearch.cfg[]
----
...
Content Studio is now available as an https://market.enonic.com/vendor/enonic/content-studio[application on Enonic Market].
