...
There are thre types of principal objects:
...
When using https://developer.enonic.com/docs/cms/stable/projects[Content Projects], each project automatically creates a set of https://developer.enonic.com/docs/cms/stable/projects#roles[project roles] in addition to the built-in roles listed above.
