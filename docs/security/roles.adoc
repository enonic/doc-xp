...
When editing a role via the users app, you instantly grant the role to users or groups as well. For a walkthrough, see the <<../admin/users#roles, Users admin tool>>.
