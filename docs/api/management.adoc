...
List all the snapshots for the installation. See https://developer.enonic.com/docs/xp/stable/deployment#backup_and_restore[Backup and Restore] for more information on snapshots.
...
Load data from a named system dump into Enonic XP. The dump read has to be stored in the `$XP_HOME/data/dump` directory. See https://developer.enonic.com/docs/xp/stable/storage#export_and_import[Export and Import] for more information on system dump/load.
...
Extract data from a given repository, branch and content path. The result will be stored in the `$XP_HOME/data/export` directory. This is useful to move a part of a site from one installation to another. See https://developer.enonic.com/docs/xp/stable/storage#export_and_import[Export and Import] for more information on content export/import.
...
Import data from a named export into Enonic XP at the desired content path. The export read has to be stored in the `$XP_HOME/data/export` directory. See https://developer.enonic.com/docs/xp/stable/storage#export_and_import[Export and Import] for more information on content export/import.
