...
NOTE: Properties starting with `_` may not be modified using this function. To rename or move a content (i.e change the _name property), use the <<#move, move function>> instead.
