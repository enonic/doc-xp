...
*object* : (<<#styles,`Styles`>>) Detail information for the modified styles.
...
Fetch site descriptor from an application.
...
*object* : (<<#site,`Site`>>) Detail information for fetched site descriptor.
...
Updates dynamic site descriptor in virtual application.
