...
|===
| Name | Kind | Details
| keys | string \| Array.<string> | Node keys to delete. Each argument could be an id, a path or an array of the two. Prefer the usage of ID rather than paths.
|===
...
|===
| Name | Kind | Details
| params | string \| Array.<string>\|object | One or multiple strings, or one or multiple arrays of strings, or an object with the following properties:
