...
|===
| Name | Type | Attributes | Details
| key | string | | Path or ID of parent to get children of
| start | number | optional | start index used for paging - default: 0
| count | number | optional | number of content to fetch, used for paging - default: 10
|===
...
https://repo.enonic.com/public/com/enonic/xp/docs/{version}/docs-{version}-libdoc.zip!/module-node-RepoConnection.html#get[Documentation]
