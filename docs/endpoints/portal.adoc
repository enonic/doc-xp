...
Portal is the default gateway for all client interactions, including APIs, XP Admin and the Site Engine. 
...
NOTE: When running the Enonic XP SDK, the portal serves a boot page on localhost:8080 with an overview of the instance.
