...
<4> Name/value pairs with the HTTP headers to be added to the response. Value can be `null`/`undefined` to remove a headers added by other controllers/filters.
