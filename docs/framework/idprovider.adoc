...
== Introduction
As part of the XP <<../iam#,IAM>> (Identity and Access management) apps and sites may be loosely associated with an IDprovider.
...
* As a <<./controllers#, controller>> - for instance by rendering a login page, or logging out the user
