...
The labels and texts used in content types, input types and other schemas can also be localized. See how to localize them in <<../cms/schemas#Schema_Localization,localization_schemas>>.
