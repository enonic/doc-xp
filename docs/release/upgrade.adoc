...
IMPORTANT: If you are using link:https://market.enonic.com/vendors/enonic/siteimprove[Siteimprove],
link:https://market.enonic.com/vendors/enonic/google-analytics[Google Analytics]
or link:https://market.enonic.com/vendors/enonic/com.enonic.app.metafields[SEO Meta Fields] applications, we recommend upgrading them to the latest
...
Enonic CLI:: Make sure you have link:https://developer.enonic.com/docs/enonic-cli[Enonic CLI] installed
...
Content Studio is now available as an link:https://market.enonic.com/vendors/enonic/content-studio[application on Enonic Market].
Documentation for Content Studio can be found link:https://developer.enonic.com/docs/content-studio[here].
