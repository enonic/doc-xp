...
XP Version:: You need to be running at least Enonic XP 8.16.x (if you are running an older version, upgrade to 8.16.x first)
...
More details about configuring `su` password can be found in <<../deployment/config#system-properties,system properties documentation>>.
...
Hash function can be configured in the <<../deployment/config#security,security service configuration>>.
