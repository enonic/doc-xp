...
For feature upgrades (7.x.0), the forming of the cluster is more complicated and require full cluster restart. Rolling update is sometimes possible but not recommended/supported out of the box.
...
WARNING: Due to security fixes, new version of Hazelcast dependency version is part of 7.7.0 release. Full cluster restart during the update is unavoidable.
