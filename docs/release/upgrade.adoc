...
To upgrade simply replace your current 7.0 runtime image with the a new v7.1 image.
...
Follow the link:../deployment/distro#XP_INSTALL[XP installation instructions] to set up an instance matching your requirements
