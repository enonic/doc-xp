...
* Make sure you have link:https://developer.enonic.com/docs/enonic-cli[Enonic CLI] installed
...
It supports Gradle 5, Java 11 and building for XP 7.
...
* link:https://market.enonic.com/vendors/enonic/thymeleaf-lib[Thymeleaf]
* link:https://market.enonic.com/vendors/enonic/xslt-lib[XSLT]
* link:https://market.enonic.com/vendors/enonic/mustache-lib[Mustache]
* link:https://market.enonic.com/vendors/enonic/http-client-lib[HTTP client]
...
Read more about Image styles link:https://developer.enonic.com/docs/content-studio/stable/editor/rich-text-editor[here]
