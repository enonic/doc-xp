...
applyPermissions now applies them in multiple branches. Content API applies permissions in both draft and master branches.

== Editorial data

// TODO more details

New concept of editorial data is introduced in XP 8. Content API now has separate methods for manipulating of metadata, data.
