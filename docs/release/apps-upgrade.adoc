...
For all schemas in XP 6, the input types <<../cms/input-types#ContentSelector,contentSelector>> and <<../cms/input-types#Tag,tag>> defaulted to selecting content across the entire repository.
