...
Below is a sample content of `build.gradle` and `gradle.properties` files for a library:
...
NOTE: You only need to use `com.enonic.xp.base` plugin if you are using XP dependencies and need to shortlink to Enonic repo
