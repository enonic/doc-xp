...
For all schemas in XP 6, the input types link:../cms/input-types#contentselector[contentSelectors] and link:../cms/input-types#tag[tag] defaulted to selecting content across the entire repository.
...
Also, please check out the documentation of the link:../framework/globals#require[require function].
