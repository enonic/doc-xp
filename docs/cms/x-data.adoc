...
_my-x-data-3_ will be enabled only for sites (which are using internal content type _portal:site_) and will be optional, meaning user has to manually turn it on in the Content Wizard.
