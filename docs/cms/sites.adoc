...
However, sites have an ability to let you add applications to them. Site applications isolated from <<projects#, projects>> applications and can't be inherited.
