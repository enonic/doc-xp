...
Sites unlock powerful functionality for managing websites and creating visually oriented content like <<pages#, pages>>, <<page-templates#,page templates>> and <<fragments#, fragments>>.
...
* <<sites/regions#, Component rendering>> (directly or via placeholders)
...
<3> Controller and filter <<mappings#,mappings>> definitions
<4> Commonly used to add <<contributions#,page contributions>> to the response
