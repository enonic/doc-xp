...
`LEGACY`:: this mode simulates the pattern matching functionality that was the default before XP 7.7.0. Not supported and will be removed without in future XP 8 versions.
