...
To simplify maintenance of forms, mixins and x-data offer a simple templating approach to reuse the same definition across various forms.
They can be injected into a form by simple name reference.
