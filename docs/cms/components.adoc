...
Drag the part component placeholder (puzzle piece) to the desired location on the page. 
The part placeholder will now appear as a blue box with a dropdown selector. The same part dropdown selector will appear in the inspect tab. 
Use one of the selectors to find the desired part component. 
...
Parts can be added to multiple pages, or even multiple times in the same page, and each instance can have different form values.
...
image::part-component-1.png[Part descrtiptor list]
image::part-component-2.png[Page Components tree]

NOTE: Custom part icons was introduced with XP 7.2.0
