...
The first step in adding a part component to a page is to edit the page content and open the inspection panel’s “Insert” tab.
...
a blue box with a dropdown selector. The same part dropdown selector will appear in the inspect panel. Use one of the selectors
...
the Inspect panel will show the part’s configuration options in a form.
...
image::context-panel_insert.png[Component list, 697px]
