...
Just like with sites, applications can be added to projects now. All functionality and all schemas (content types, schemas, mixins) and descriptors (pages, parts, layouts) from the app will be available within the scope of the project.
