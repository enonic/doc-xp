...
The schema system provides a range of standard <<Input Types>>, such as TextLine and ContentSelector.
...
Developers can still take control over URLs when required, through the use of <<Filters>> and <<Mappings>>.
