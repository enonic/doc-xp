...
The export receives the request and response objects as parameters and must return a response object as done in <<../framework/http#http-controller, http_controllers>>.
