...
image:714-sdk-welcome.png["SDK Welcome page", 75%]
...
Site Mappings can now be used to customize the behavior of Image, Attachment and Component services <<cms/mappings#services, Services>>.
...
Also, <<cms/mappings#mappings, controller mappings>> will now work on project level, which means you may also write custom previews without using sites.
...
TypeScript definitions are published on link:https://www.npmjs.com/search?q=%40enonic-types[NPM]
...
NOTE: This feature requires link:https://developer.enonic.com/docs/content-studio/release#2_3_0[Content Studio v2.3].
...
NOTE: v7.1 is fully backward compatible with v7.0 and was released in parallel with link:https://developer.enonic.com/docs/content-studio/release#2_1_0[Content Studio v2.1].

This update introduces new features and improvements as well as 28 bugfixes.
The link:https://github.com/enonic/xp-distro/releases/tag/v7.1.0[complete list of changes] is available on Github.
...
* Content Studio - Is now available as an app to download from link:https://market.enonic.com/vendors/enonic/content-studio[Enonic Market].
...
as described in the link:https://developer.enonic.com/start[getting started section] of the developer portal

The CLI is available for Mac, Linux and Windows. For more information, check out the link:https://developer.enonic.com/docs/enonic-cli[full documentation].
...
It is now available as a separate application on link:https://market.enonic.com/vendors/enonic/content-studio[Enonic Market]
...
For Content Studio release notes, check out the link:https://developer.enonic.com/docs/content-studio[new documentation].
