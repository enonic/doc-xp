...
* `webapps`, `projects` and `idproviders` have been added to the <<runtime/management#management_endpoint, Management API>>.
* A new healthcheck (`health`) and readiness (`ready`) endpoint has been added to the <<runtime/statistics#statistics_endpoint, Management API>>.
