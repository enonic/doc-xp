...
NOTE: This feature requires https://developer.enonic.com/docs/content-studio/release#2_3_0[Content Studio v2.3].
...
NOTE: v7.1 is fully backward compatible with v7.0 and was released in parallel with https://developer.enonic.com/docs/content-studio/release#2_1_0[Content Studio v2.1].
