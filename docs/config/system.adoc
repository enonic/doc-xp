...
This section describes all standard configuration files and options for Enonic XP. These are primarily relevant when hosting XP on your own infrastructure.
...
The `system` IdProvider uses an implementation called the standard ID provider.
...
Configure the content behaviour.
