...
The configuration files can be deployed to your Enonic XP instance's `config` directory, and are automatically reloaded when changed. For details on configuration file syntax and behavior, see the <<../config#,Configuration reference documentation>>.
