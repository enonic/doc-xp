...
* <<app-engine/index#,Javascript/Java app-engine>> with a powerful <<framework/index#, Javascript development framework>>
* <<nosql/index#, NoSQL repository>> for storing any kind of data (based on Elasticsearch)
* <<Identity/index#, Identity providers>> for pluggable authentication and authorization
* <<admin/index#, Admin Console>> that can be extended
* <<content/index#,Content Management services>> that work hand-in-hand with Content Studio
